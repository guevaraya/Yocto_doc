...
现在您已经有了使用 Yocto 项目的经验，您可能会自问“现在改做什么？” Yocto 项目有很多源码信息包括网站，wiki页面和用户手册：

+ __网站：__ Yocto 项目的官网提供背资料，最新的构建，重大新闻，完整的开发文档和你可以融入的丰富的项目开发社区。
+ __开发者视频教程：__ [Yocto 项目入门视频][24]-为不熟悉 Yocto 项目单熟悉 Linux 主机构建的用户提供了 30分钟时长的新开发者视频教程。虽然这个视频有些过时，但是对于初学者上面的基本概念和介绍都是有用的。
+ __Yocto 项目概述和概念手册：__ [Yocto 项目概述和概念手册][25]是一个对学习 Yocto 项目非常有用的地方。手册介绍了 Yocto 项目和他的开发环境。同时也提供了 Yocto 项目有关各方面的概念信息。
+ __Yocto项目WIKI:__ [Yocto 项目WIKI][26]提供了进一步深入 Yocto 项目的额外信息，如发布信息，项目计划和质量信息。
