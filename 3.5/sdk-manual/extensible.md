...
>提示
>
>如果你需要增加一个工具将其打包到构建到设备里的源码里，你可以将主机软件和设备软件分开编译是实现而不是一起编译。根据这个选项“-also-native”，你可以只增加工具到其中一个配方文件。

2.5.6. 添加 Node.js 模块
======
你可以用devtool add 命令的两个方法添加 Node.js 模块：
1. 通过 npm；
2. 通过仓库或本地源码
通过下面的格式用npm  添加 Node.js 模块：
```
