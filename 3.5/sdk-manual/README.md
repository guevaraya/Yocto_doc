...
* [2. 使用可扩展 SDK](extensible.md#2-使用可扩展-SDK)
  * [2.1. 为什么要使用可扩展的 SDK 以及里面有些什么](#21-为什么要使用可扩展的-SDK-以及里面有些什么)
  ...
  * [2.4.  在你的 SDK 流程中运用 devtool](#24-在你的-sdk-流程中运用-devtool)
    ...
    * [2.4.3. 用 devtool upgrade 更新来创建一个新配方，用来兼容软件的新版本](#243-用-devtool-upgrade-更新来创建一个新配方-用来兼容软件的新版本)
  * [2.5. 进一步理解 devtool 的创建操作](#25-进一步理解-devtool-的创建操作)
    * [2.5.1. 名称和版本号](#251-名称和版本号)
    * [2.5.2. 依赖检查与映射](#252-依赖检查与映射)
    * [2.5.3. 许可证检查](#253-许可证检查)
    * [2.5.4. 增加只用 Makefile 编译的软件](#254-增加只用-Makefile-编译的软件)
    * [2.5.5. 添加本机工具](#255-添加本机工具)
    * [2.5.6. 添加 Node.js 模块](#256-添加-Nodejs-模块)
