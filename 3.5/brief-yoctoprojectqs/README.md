...
>+ 你可能在Window10上用[Windows子系统Linux（WSLv2）][4]配置构建主机。
>
>> __提示__
>>
>> Yocto 项目不兼容 WSLv1, 与WSLv2兼容的，但官方并不支持也没有经过认证。如果你还在使用WSL，请升级到WSLv2.
>
> 想获取更多信息请查看Yocto 项目任务开发手册的[在Window子系统配置使用WSLv2][29]段落。
